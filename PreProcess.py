...
data = pd.read_csv('Police_Incidents.csv')
...
dataNoDupes = dataNoNULL.drop_duplicates()
dataFinal = dataNoDupes.drop(columns=['UCR_1_Category', 'UCR_1_Description', 'UCR_2_Category', 'UCR_2_Description'])

if os.path.exists('New_Police_Incidents.csv'):
    print('file exists')
else:
    dataFinal.to_csv('New_Police_Incidents.csv')